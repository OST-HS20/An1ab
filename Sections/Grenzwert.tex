...
Wenn eine Folge \underline{monoton} (Siehe \verweiseref{monotonie}) \textbf{und} \underline{beschränkt} (Siehe \verweiseref{beschränkt}) ist, dann ist diese auch Konvergent.
